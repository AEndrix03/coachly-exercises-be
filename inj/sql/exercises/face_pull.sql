...
BEGIN
    ...
    SELECT id INTO v_id FROM exercises.muscle WHERE code='teres_minor'; IF v_id IS NOT NULL THEN INSERT INTO exercises.exercise_muscle VALUES(v_ex_id,v_id,'tertiary',25,NOW()) ON CONFLICT DO NOTHING; END IF;
